...
const API_KEY = import.meta.env.VITE_FRONTEND_FORGE_API_KEY || GOOGLE_MAPS_API_KEY;
const FORGE_BASE_URL =
  import.meta.env.VITE_FRONTEND_FORGE_API_URL ||
  "https://forge.butterfly-effect.dev";
const MAPS_PROXY_URL = `${FORGE_BASE_URL}/v1/maps/proxy`;
const USE_MANUS_PROXY = Boolean(import.meta.env.VITE_FRONTEND_FORGE_API_KEY || import.meta.env.VITE_FRONTEND_FORGE_API_URL);
